...
/****** Object:  Database [StudentDB]    Script Date: 2/3/2016 11:41:36 AM ******/
CREATE DATABASE [StudentDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'StudentDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\StudentDB.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'StudentDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\StudentDB_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
/****** Object:  Table [dbo].[tbl_students]    Script Date: 2/3/2016 11:41:48 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[tbl_students](
	[id] [int] NULL,
	[nama] [nchar](100) NOT NULL,
	[alamat] [nchar](100) NOT NULL,
	[umur] [int] NOT NULL
) ON [PRIMARY]
